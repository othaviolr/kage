...
public record Limits(Money dailyTransferLimit, Money monthlyTransferLimit, Money pixDailyLimit,  Money pixNightLimit)
{
    public Limits {
    ...
    public static Limits defaultLimits() {
        return new Limits(Money.of("5000.00"), Money.of("20000.00"), Money.of("2000.00"), Money.of("1000.00")
        );
    }

    public Limits updateDailyTransferLimit(Money newLimit) {
        return new Limits(newLimit, this.monthlyTransferLimit, this.pixDailyLimit, this.pixNightLimit);
    }

    public Limits updateMonthlyTransferLimit(Money newLimit) {
        return new Limits(this.dailyTransferLimit, newLimit, this.pixDailyLimit, this.pixNightLimit);
    }

    public Limits updatePixDailyLimit(Money newLimit) {
        return new Limits(this.dailyTransferLimit, this.monthlyTransferLimit, newLimit, this.pixNightLimit);
    }

    public Limits updatePixNightLimit(Money newLimit) {
        return new Limits(this.dailyTransferLimit, this.monthlyTransferLimit, this.pixDailyLimit, newLimit);
    }
}